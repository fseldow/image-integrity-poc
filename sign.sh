...
echo "####################################"
curl -Lo notation.tar.gz https://github.com/notaryproject/notation/releases/download/v1.0.0-rc.4/notation_1.0.0-rc.4_$(uname)_$(arch).tar.gz
tar xvzf notation.tar.gz

alias notation=./notation

notation_plugin_install_path="${HOME}/.config/notation/plugins/azure-kv"
if [[ $(uname) == "Darwin" ]]; then
    notation_plugin_install_path="${HOME}/Library/Application Support/notation/plugins/azure-kv"
fi
mkdir -p "$notation_plugin_install_path"

curl -Lo notation-azure-kv.tar.gz \
    https://github.com/Azure/notation-azure-kv/releases/download/v0.6.0/notation-azure-kv_0.6.0_$(uname)_$(arch).tar.gz
tar xvzf notation-azure-kv.tar.gz -C "$notation_plugin_install_path" notation-azure-kv
